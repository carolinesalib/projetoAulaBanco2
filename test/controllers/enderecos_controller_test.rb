...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { bairro_id: @endereco.bairro_id, cep: @endereco.cep, logradouro: @endereco.logradouro } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { bairro_id: @endereco.bairro_id, cep: @endereco.cep, logradouro: @endereco.logradouro } }
