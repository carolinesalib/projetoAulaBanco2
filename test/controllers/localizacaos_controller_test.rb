...
class LocalizacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localizacao" do
    assert_difference('Localizacao.count') do
      post localizacaos_url, params: { localizacao: { endereco_id: @localizacao.endereco_id, geolocalizacao: @localizacao.geolocalizacao } }
    end
  ...
  test "should update localizacao" do
    patch localizacao_url(@localizacao), params: { localizacao: { endereco_id: @localizacao.endereco_id, geolocalizacao: @localizacao.geolocalizacao } }
